const paths = {
  ...
  sparkles: <><path d="m12 3 1.4 4.1L17.5 8.5l-4.1 1.4L12 14l-1.4-4.1-4.1-1.4 4.1-1.4Z"/><path d="m18 14 .9 2.1L21 17l-2.1.9L18 20l-.9-2.1L15 17l2.1-.9Z"/><path d="m6 15 .7 1.6 1.6.7-1.6.7L6 19.6 5.3 18l-1.6-.7 1.6-.7Z"/></>,
